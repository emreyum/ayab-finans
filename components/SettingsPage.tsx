...
create policy "Public Access" on public.personnel_definitions for all using (true) with check (true);`)}
  ...
  return (
    <div className="max-w-5xl mx-auto pb-20">
      <div className="bg-white rounded-lg border border-slate-100 overflow-hidden min-h-[600px]">
        {/* Tabs */}
        <div className="flex border-b border-slate-100 overflow-x-auto">
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-bold transition-colors flex items-center justify-center gap-2 whitespace-nowrap ${
              activeTab === 'general' ? 'bg-slate-50 text-slate-700 border-b-2 border-slate-800' : 'text-slate-500 hover:bg-slate-50'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-bold transition-colors flex items-center justify-center gap-2 whitespace-nowrap ${
              activeTab === 'categories' ? 'bg-slate-50 text-slate-700 border-b-2 border-slate-800' : 'text-slate-500 hover:bg-slate-50'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-bold transition-colors flex items-center justify-center gap-2 whitespace-nowrap ${
              activeTab === 'accounts' ? 'bg-slate-50 text-slate-700 border-b-2 border-slate-800' : 'text-slate-500 hover:bg-slate-50'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-bold transition-colors flex items-center justify-center gap-2 whitespace-nowrap ${
              activeTab === 'personnel' ? 'bg-slate-50 text-slate-700 border-b-2 border-slate-800' : 'text-slate-500 hover:bg-slate-50'
            }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-4 px-6 text-sm font-bold transition-colors flex items-center justify-center gap-2 whitespace-nowrap ${
              activeTab === 'users' ? 'bg-slate-50 text-slate-700 border-b-2 border-slate-800' : 'text-slate-500 hover:bg-slate-50'
            }`}
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {categories.map((cat) => (
                    <div key={cat.id} className="flex items-center justify-between p-3 bg-white border border-slate-100 rounded-lg transition-all group">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {accounts.map(account => (
                        <div key={account.id} className="bg-white p-5 rounded-lg border border-slate-100 flex justify-between items-center group">
          ...
          {activeTab === 'personnel' && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                  {/* Form */}
                  <div className="xl:col-span-2 bg-slate-50 p-6 rounded-lg border border-slate-100 relative">
                      <div className="flex justify-between items-start mb-4">
            ...
            <div className="space-y-8">
               ...
               <div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                       {users.map(u => (
                           <div key={u.id} className="bg-white p-4 rounded-lg border border-slate-100 flex items-center justify-between group">
                               <div className="flex items-center gap-3">
                                   <img 
