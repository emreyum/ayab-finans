...
export const Receivables: React.FC<ReceivablesProps> = ({ totalAmount }) => {
  ...
  return (
    <div className="glass-card p-5 rounded-2xl border border-white/40 flex flex-col items-center justify-center h-full min-h-[280px]">
      <div className="w-full flex justify-between items-start mb-2">
        <h2 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Toplam Hesap Avans Alacağı</h2>
